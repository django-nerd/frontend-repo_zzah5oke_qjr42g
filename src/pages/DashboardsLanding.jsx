...
const roles = [
  ...
  { slug: 'client_executive', name: 'Client Executive', icon: Users, desc: 'Portfolio oversight and executive summaries' },
]
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex items-start justify-between gap-4">
          ...
          {user && (
            <Link to={`/dashboard/${user.role}`} className="rounded-md bg-blue-600 hover:bg-blue-500 px-4 py-2">Go to my dashboard</Link>
          )}
        </div>
